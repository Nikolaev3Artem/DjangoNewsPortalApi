    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.CharField(blank=True, max_length=1500, verbose_name="Опис"),
                ),
                (
                    "route",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(max_length=300, null=True, verbose_name="Назва"),
                ),
                (
                    "news_creator",
                    models.CharField(
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=500,
                        null=True,
                        verbose_name="Посилання на картинку",
                    ),
                ),
                (
                    "description",
                ...
                (
                    ...
                    models.CharField(
                        ...
                        null=True,
                        unique=True,
                        verbose_name="Кастомне посилання",
                    ),
                ),
                (
                    "time_to_read",
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=300,
                        null=True,
                        verbose_name="Альтернативна назва картинки",
                    ),
                ),
                (
                    "is_approved",
                    models.BooleanField(
                        default=False,
                        verbose_name="Підтвердження валідності новини для її виставлення",
                    ),
                ),
                ...
                (
                    "categories",
                    models.ManyToManyField(blank=True, to="news.categories"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "key",
                    models.CharField(max_length=2000, null=True, verbose_name="Ключ"),
                ),
                (
                    "requests",
                    models.IntegerField(default=0, verbose_name="Використано запросів"),
                ),
                (
                    "active",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="rated_news", through="news.Rating", to="news.newsuser"
            ),
        ),
        migrations.AddField(
            model_name="news",
